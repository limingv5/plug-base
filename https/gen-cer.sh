...
/usr/bin/openssl x509 -req -sha256 -days 36500 -in $outputPath/$domain.csr -CA ${outputPath}/../rootCA.crt -CAkey ${outputPath}/../rootCA.key -CAcreateserial -out $outputPath/$domain.crt
